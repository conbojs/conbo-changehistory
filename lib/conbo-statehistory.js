...
/** @lends conbo.StateManager.prototype */
{
	...
	set currentIndex(value)
	{
		...
		this.__target.removeEventListener(conbo.Event.CHANGE, this.__changeHandler, this);
		...
		this.__target.addEventListener(conbo.Event.CHANGE, this.__changeHandler, this);
