(function(window, factory)
{
	...
	{
		define('conbo-statehistory', [conbo.ConboEvent.CHANGE], factory);
	}
	else if (typeof module !== 'undefined' && module.exports)
	{
		module.exports = factory(require(conbo.ConboEvent.CHANGE));
		exports.default = module.exports;
	}
	else
	{
		window.StateHistory = factory(window.conbo);
	}
}
(this, function(conbo)
{
